...
private:
    ...
    juce::String universalText =
        ...
        "Cmd+Ctrl+P/N:track switch  Cmd+M:scale  Cmd+A:select all notes  Cmd+Ctrl+H:chord track  Cmd+Z:undo  Cmd+Shift+Z:redo  Cmd+Ctrl+A:enter automation edit mode  Cmd+Ctrl+W:automation Read/Touch(touch a plugin knob to record/preview into its lane)";
